...
async def get_many_api_catalog_items__get(
    *,
...
async def create_one_api_catalog_items__post(
...
async def get_one_api_catalog_items__uid___get(
...
async def update_one_api_catalog_items__uid___put(
...
async def delete_one_api_catalog_items__uid___delete(
    *, client: AuthenticatedClient, uid: str,

...
def get_many_api_payments__get(
    *,
...
def create_one_api_payments__post(
...
def get_one_api_payments__uid___get(
...
def update_one_api_payments__uid___put(
...
def delete_one_api_payments__uid___delete(
    *, client: AuthenticatedClient, uid: str,

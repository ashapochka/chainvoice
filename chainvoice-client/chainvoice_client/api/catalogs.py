...
def get_many_api_catalogs__get(
    *,
...
def create_one_api_catalogs__post(
...
def get_one_api_catalogs__uid___get(
...
def update_one_api_catalogs__uid___put(
...
def delete_one_api_catalogs__uid___delete(
    *, client: AuthenticatedClient, uid: str,

...
async def get_many_api_blockchain_contracts__get(
...
async def create_one_api_blockchain_contracts__post(
...
async def get_one_api_blockchain_contracts__uid___get(
...
async def update_one_api_blockchain_contracts__uid___put(
...
async def delete_one_api_blockchain_contracts__uid___delete(
    *, client: AuthenticatedClient, uid: str,

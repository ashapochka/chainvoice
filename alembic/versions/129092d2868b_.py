...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('payments', sa.Column('blockchain_tx_address', sa.VARCHAR(), autoincrement=False, nullable=True))
    op.create_index('ix_payments_blockchain_tx_address', 'payments', ['blockchain_tx_address'], unique=False)

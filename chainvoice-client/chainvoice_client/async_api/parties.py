...
async def get_many_api_parties__get(
...
async def get_one_api_parties__uid___get(
...
async def update_one_api_parties__uid___put(
...
async def delete_one_api_parties__uid___delete(
    *, client: AuthenticatedClient, uid: str,
